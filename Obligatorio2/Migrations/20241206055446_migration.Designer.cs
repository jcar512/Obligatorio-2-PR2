...
namespace Obligatorio2.Migrations
{
    ...
    [Migration("20241206055446_migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Obligatorio2.Models.FechaReserva", b =>
                {
                    b.Property<int>("FechaReservaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FechaReservaId"), 1L, 1);
                    ...
                    b.HasKey("FechaReservaId");

                    b.HasIndex("ReservaId");

                    b.ToTable("FechasReservadas");
                });
            ...
            modelBuilder.Entity("Obligatorio2.Models.Huesped", b =>
                {
            ...
            modelBuilder.Entity("Obligatorio2.Models.Huesped", b =>
                {
                    b.HasOne("Obligatorio2.Models.Usuario", "Usuario")
                        .WithOne("Huesped")
                        .HasForeignKey("Obligatorio2.Models.Huesped", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
